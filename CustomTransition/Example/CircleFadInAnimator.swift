...
class CircleFadeInAniamtor : UIViewController, UIViewControllerAnimatedTransitioning{
    ...
    func animateTransition(using transitionContext: UIViewControllerContextTransitioning) {
        ...
        let initialImageView = setupImageView(#imageLiteral(resourceName: "create_plus_animation"), frame: CGRect(x: 0.0, y: 3.0, width : 49.0, height : 49.0), in: imageContainer)
        ...
        let finalImageView = setupImageView(#imageLiteral(resourceName: "tabbar_cross_animation"), frame: initialImageView.frame, in: imageContainer)
    ...
    private func setupImageView(_ image : UIImage, frame : CGRect, in container : UIView) -> UIImageView{
