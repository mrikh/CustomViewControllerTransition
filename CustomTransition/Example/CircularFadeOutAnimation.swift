...
class CircularFadeOutAnimation : UIViewController, UIViewControllerAnimatedTransitioning{
    ...
    func animateTransition(using transitionContext: UIViewControllerContextTransitioning) {
        ...
        let initialImageView = setupImageView(#imageLiteral(resourceName: "tabbar_cross_animation"), frame: CGRect(x: 0.0, y: 3.0, width : 49.0, height : 49.0), on: imageContainer)
        initialImageView.layer.cornerRadius = 25.0
        initialImageView.backgroundColor = UIColor.clear
        ...
        let finalImageView = setupImageView(#imageLiteral(resourceName: "create_plus_animation"), frame: initialImageView.frame, on: imageContainer)
        finalImageView.layer.cornerRadius = 25.0
        finalImageView.clipsToBounds = false
        finalImageView.backgroundColor = UIColor.clear
    ...
    private func setupImageView(_ image : UIImage, frame : CGRect, on container : UIView) -> UIImageView{
